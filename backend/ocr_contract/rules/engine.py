from backend.ocr_contract.rules.validators.required import check_required
from backend.ocr_contract.rules.validators.wage import check_wage
from backend.ocr_contract.rules.validators.time import check_time
